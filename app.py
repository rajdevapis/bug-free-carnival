...
android {{
    ...
    buildTypes {{
        debug {{ minifyEnabled true; shrinkResources false; proguardFiles getDefaultProguardFile('proguard-android-optimize.txt'), 'proguard-rules.pro' }}
...
def make_proguard(network="unity"):
    ...
    # WebView JS bridge (window.NativeAds.showRewarded/showInterstitial) methods
    # must survive minification, warna custom website buttons kaam karna band kar dete.
